    ...
    for i in range(number_of_monsters):
        ...
        if not any([entity for entity in entities if entity.x == x and entity.y == y]):
            if randint(0, 100) < 80:
                ...
                monster = Entity(x, y, "T", colors.get("darker_green"), "Troll", render_order=RenderOrder.ACTOR, blocks=True, fighter=fighter_component, ai=ai_component)
    ...
    for i in range(number_of_items):
        ...
        if not any([entity for entity in entities if entity.x == x and entity.y == y]):
            ...
            if item_chance < 80:
                ...
                item_component = Item(use_function=cast_lightning, damage=4, maximum_range=5)
...
def make_map(game_map, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities, max_monsters_per_room, max_items_per_room, colors):
    ...
    for r in range(max_rooms):
        ...
        for other_room in rooms:
            ...
            # Finaly, append the new room to the list
